...
var city = [
    ...
    ["贵阳","遵义","六盘水","铜仁","毕节","安顺","黔南","黔东南","黔西南"],
    ["海口","三亚","三沙","儋州","五指山","文昌","琼海","万宁","东方","洋浦经济开发区","白沙黎族自治县","昌江黎族自治县","乐东黎族自治县","陵水黎族自治县",
        "保亭黎族苗族自治县","琼中黎族苗族自治"],
    ["石家庄","唐山市","秦皇岛","邯郸","邢台","保定","张家口","承德","沧州","廊坊","衡水","定州","辛集"],
    ["郑州","开封","洛阳","南阳","漯河","许昌","三门峡","平顶山","周口","驻马店","新乡","鹤壁","焦作","濮阳","安阳","商丘","信阳","济源"],
    ["哈尔滨","齐齐哈尔","鸡西","鹤岗","双鸭山","大庆","伊春","佳木斯","七台河","牡丹江","黑河","绥化","大兴安岭地区","绥芬河","抚远"],
    ["武汉","黄石","十堰","宜昌","襄阳","鄂州","荆门","孝感","荆州","黄冈","咸宁","随州","恩施土家族苗族自治州","仙桃","潜江","天门","神农架林区"],
    ["长春","吉林","四平","辽源","通化","白山","白山","白城","延边朝鲜族自治州"],
    ["长沙","株洲","湘潭","衡阳","邵阳","岳阳","常德","张家界","益阳","娄底","郴州","永州","怀化","湘西土家族苗族自治州"],
...
$(function(){
    ...
    $(".selectSchool").click(function(){
    	var display = $('.province').css('display');
        $('.cityShool').val("");
        // console.log(display)
		if (display == 'none') {
            $('.province').show();
    ...
    $('.proSchool').click(function () {
        var display = $('.life').css('display');
        // console.log(display)
        if (display == 'none') {
            $('.life').show();
        } else {
    ...
    $('.province li').click(function () {
        ...
        $('.city li').remove();
        $.each(uLi,function () {
            $('.city').append('<li>' + this + '</li>')
        });
        $('.city li').click(function () {
            $('.cityShool').val($(this).text());
        });

        lii = proSchool[index];
        $('.life li').remove();
        $.each(lii,function () {
            $('.life').append('<li>' + this + '</li>')
        });
        $('.life li').click(function () {
            $('.shOol').val($(this).text());
        });
    });
});